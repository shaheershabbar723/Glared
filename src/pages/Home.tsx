...
import { ChevronLeft, ChevronRight, ArrowRight, Play, CheckCircle, Star, Users, Globe, Zap, Camera, Palette, Clock, Calendar } from 'lucide-react';
...
const portfolioImages = [
  {
    ...
    after: 'https://images.pexels.com/photos/1624229/pexels-photo-1624229.jpeg?auto=compress&cs=tinysrgb&w=800',
    category: 'Menswear'
  },
  {
    before: 'https://images.pexels.com/photos/1036622/pexels-photo-1036622.jpeg?auto=compress&cs=tinysrgb&w=800',
    after: 'https://images.pexels.com/photos/1462637/pexels-photo-1462637.jpeg?auto=compress&cs=tinysrgb&w=800',
    category: 'Womenswear'
  },
  {
    before: 'https://images.pexels.com/photos/1040945/pexels-photo-1040945.jpeg?auto=compress&cs=tinysrgb&w=800',
...
export function Home() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section ref={transformationRef} id="transformation" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transition-all duration-1000 ${isVisible.transformation ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto font-light">
              Experience the power of AI-enhanced fashion photography
            </p>
          </div>

          <div className="max-w-4xl mx-auto">
            <div 
              className="relative w-full h-[600px] rounded-2xl overflow-hidden shadow-2xl bg-white select-none cursor-ew-resize"
              onClick={(e) => {
            ...
            >
              {/* Before Image */}
              <div 
                className={`absolute inset-0 ${isDragging ? 'transition-none' : 'transition-all duration-150'}`}
                style={{ clipPath: `inset(0 ${100 - sliderPosition}% 0 0)` }}
              >
                <img
                  src={portfolioImages[currentSlide].before}
                  alt="Before AI Enhancement"
                  className="w-full h-full object-cover"
                />
                <div className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-sm rounded-lg px-4 py-2">
              ...
              >
                <img
                  src={portfolioImages[currentSlide].after}
                  alt="After AI Enhancement"
                  className="w-full h-full object-cover"
                />
                <div className="absolute bottom-6 right-6 bg-gradient-to-r from-yellow-600 to-yellow-500 backdrop-blur-sm rounded-lg px-4 py-2">
              ...
              {/* Slider Handle */}
              <div 
                className={`absolute top-0 bottom-0 w-1 bg-yellow-600 shadow-lg cursor-ew-resize z-20 flex items-center justify-center select-none ${isDragging ? 'transition-none' : 'transition-all duration-150'}`}
              ...
              >
                <div className="w-8 h-8 bg-white rounded-full shadow-lg flex items-center justify-center border-2 border-yellow-600">
                  <div className="w-1 h-4 bg-yellow-600 rounded"></div>
                  <div className="w-1 h-4 bg-yellow-600 rounded ml-1"></div>
                </div>
              </div>

              {/* Category Label */}
              <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-sm rounded-lg px-4 py-2 border border-gray-200">
                <span className="text-black text-sm font-medium">{portfolioImages[currentSlide].category}</span>
              </div>
            </div>
